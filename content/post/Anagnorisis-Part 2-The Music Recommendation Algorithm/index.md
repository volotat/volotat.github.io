---
title: "Anagnorisis. Part 2: The Music Recommendation Algorithm."
...
One of the main ideas of Anagnorisis is to have completely open recommendation engine available for users to not only view but also modify as they wish. When a user uses the music player integrated into the project, they have the ability to influence how often songs are played by rating them and based on those ratings training personal model that can estimate the ratings of the user.

In particular the mechanism looks like this:
- User sets up the path to local music folder
- Rates some of the songs according to their own preferences
- After gathering some data goes to “Train” page and press “Train music evaluator” to train the preference model
