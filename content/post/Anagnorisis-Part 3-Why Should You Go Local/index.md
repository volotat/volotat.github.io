---
title: "Anagnorisis. Part 3: Why Should You Go Local?"
...
## Introduction
In today's digital age, an increasing amount of personal data is stored on cloud services, often beyond our direct control. While these platforms offer convenience, they also pose significant risks regarding data ownership, privacy, and longevity. Recent incidents, such as the cyberattacks on the [Internet Archive](https://web.archive.org/), highlight the vulnerability of digital repositories. In October 2024, the Internet Archive suffered a data breach that [exposed](https://www.wired.com/story/internet-archive-hacked/) information from over 31 million user accounts. This breach was accompanied by DDoS attacks, leading to intermittent service [disruptions](https://www.theverge.com/2024/10/14/24269741/internet-archive-online-read-only-data-breach-outage). Furthermore in March 2023, a U.S. District Court ruled that the Internet Archive's practice of lending digitized books online constituted copyright infringement, leading to a permanent [injunction](https://en.wikipedia.org/wiki/Hachette_v._Internet_Archive) against such activities. These events underscore how external factors can [jeopardize](https://brownstone.org/articles/they-are-scrubbing-the-internet-right-now/) access to information stored online.
...
These digital traces are not just passive records, they actively contribute to the construction of our digital personas. Machine learning algorithms can analyze this data to [predict personality traits](https://pubmed.ncbi.nlm.nih.gov/38753373/), highlighting the intimate connection between our data and our identities.
...
Recognizing the need for accessible local storage management, the [Anagnorisis](https://github.com/volotat/Anagnorisis) project is developing as a way to assist users in organizing and preserving their data effectively. The idea behind Anagnorisis is to offer a set of tools that facilitate migration from cloud services such as Notion, Spotify, Pinterest or Youtube to local environments, allowing users to easily find, rate and enjoy their data just as effectively as with any of these services. By providing a user-friendly interface and AI-powered features, Anagnorisis ensures that personal data remains under the user's control, protected from external threats and accessible for future generations.
