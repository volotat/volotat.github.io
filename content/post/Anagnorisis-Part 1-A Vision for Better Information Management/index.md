---
title: "Anagnorisis. Part 1: A Vision for Better Information Management."
...
slug: anagnorisis-part-1-a-vision-for-better-information-management
...
![A rough representation on how such recommendation system might work](Anagnorisis_graph.png)

I particularly like the option of using [p2p Network](https://en.wikipedia.org/wiki/Peer-to-peer) as a main datasource of such system. In this case we can completely move away from centralized services that control the flow of information and give users a choice to choose what kind of data they need, without any need for content moderation or sharing their personal data. To speed up calculations and not spend time and resources downloading unnecessary data, the data embeddings might be precalculated on the data provider side. So we can check if the data is valuable for us at first and only then accessing it.
